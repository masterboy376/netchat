...
const FriendCard = ({ username, name, uid }) => {
    ...
    return (
        <div onClick={() => { router.push(`/?uid=${uid}`) }} className={`flex items-center p-2 rounded-xl ${isDark ? 'hover:bg-gray-800 bg-slate-900' : 'hover:bg-gray-200 bg-slate-100'} cursor-pointer my-1`}>
