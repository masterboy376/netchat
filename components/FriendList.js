...
const FriendList = () => {
    ...
    return (
        <div className={`h-full w-full overflow-y-auto border-r ${isDark ? 'border-gray-700' : 'border-gray-200'}`}>

            {/* header */}
            <div className={`fixed flex items-center w-full border-b border-r ${isDark ? 'bg-gray-900 border-gray-700' : 'bg-white border-gray-200'} bg-opacity-70 backdrop-blur-sm z-10 p-1 sm:p-2 shadow-sm`}>
